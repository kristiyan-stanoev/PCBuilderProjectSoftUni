...
namespace PCBuilder.Data.Migrations
{
    ...
    [Migration("20180825131126_RemovedColorFromCaseAndAddedImage")]
    partial class RemovedColorFromCaseAndAddedImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCBuilder.Models.PCsMemories", b =>
                {
                    ...
                    b.HasKey("MemoryId", "PCId");

                    b.HasIndex("PCId");

                    b.ToTable("PCsMemories");
                });
            ...
            modelBuilder.Entity("PCBuilder.Models.PCsMemories", b =>
                {
                    ...
                    b.HasOne("PCBuilder.Models.PC", "PC")
                        .WithMany("MemorySticks")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
